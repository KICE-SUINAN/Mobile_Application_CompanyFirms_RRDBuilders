    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.home) {
                    Toast.makeText(build1.this, "Home Selected", Toast.LENGTH_SHORT).show();
                    Intent intent1 = new Intent(build1.this, MainActivity.class);
                    ...
                    Toast.makeText(build1.this, "Share Selected", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(build1.this, "Rate Us Selected", Toast.LENGTH_SHORT).show();
                    Intent intent1 = new Intent(build1.this, RateUs.class);
                    startActivity(intent1);
                    finish();
                    return true;
                }
